...
public class Server {
    ...
    public static class LogoutHandler implements Handler {
        ...
        public void handle(@NotNull Context context){
            ...
            try {
                if(logoutRequest.getUsername()==null || logoutRequest.getAuthToken()==null){
                    throw new Exception("Bad Request");
                }
    ...
    public static class JoinGameHandler implements Handler {
        ...
        public void handle(@NotNull Context context){
            ...
            try {
                if(joinGameRequest.getPlayerColor()==null || createGameRequest.getGameID()==null || createGameRequest.getAuthToken()==null){
                    throw new Exception("Bad Request");
                }
